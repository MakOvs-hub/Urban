...
#### По такому принципу строятся все базовые визуализации библиотеки, такие как:
 - Диаграмма рассеяния
![Диаграмма рассеяния](Pic/plt_scatter.png)
```python
...
```
 - 'Тепловая карта'
![Тепловая карта](Pic/plt_imshow.png)
```python
...
```
 - Круговая диаграмма
![Круговая диаграмма](Pic/plt_pie.png)
```python
...
![Линейный график2](Pic/newplot1.png)
```python
...
Для оценки работы с данными библиотека составим **сравнительную таблицу** с распределением оценок по различным категориям и отобразим изменения котировок Nvidia.

| Библиотека | Интерактивность | Простота к освоению    | Информативность | Гибкость | Производительность | Сумма баллов |
|------------|-----------------|------------------------|-----------------|----------|--------------------|--------------|
...
**Ну и графики котировок Nvidia в Matplotlib, Seaborn и Plotly:**
**Matplotlib**
![Matplotlib](Pic/nv1.png)
```python
...
data = yf.download('NVDA','2016-01-01','2024-08-01')

data['Close'].plot(title='График акций Nvidia')
plt.show()
```
**Seaborn**
