...
class Buyer(models.Model): # модель представляющая покупателя.
    ...
    balance = models.DecimalField(max_digits=100000, decimal_places=10) # баланс(DecimalField - поле для дробных чисел)
...
class Game(models.Model): # модель представляющая игру.
    ...
    cost = models.DecimalField(max_digits=100000, decimal_places=10) #цена(DecimalField - поле для дробных чисел)
    size = models.DecimalField(max_digits=100000, decimal_places=10) #размер файлов игры(DecimalField - поле для дробных чисел)
