my_numb = [3,7,7,8,65,9,454,787,354,45]
they_numb = [3,7,7,8,65,9,454,787,354,45]

result = map(lambda x,y: x+y, my_numb, they_numb)
print(list(result))
...
result2 = list(map(lambda x,y: x == y, first, second))
print(result2)
